...
const conditions = [
    {
    //No further inquiry, not case specific, already paid attorney fee, no premium processing
        condition: ((!isFurtherInquiry) && (!isCaseSpecific) && hasPaid && (!isPp)),
        message: `
        ...
        <p>&nbsp;</p>
        <p>As a reminder, please ensure to include your order ID #${getOrderID()} in the memo/notes section if possible. After the payment is complete, please upload a receipt to the "Additional Documents" section of your account for our verification purposes.</p>
        <p>&nbsp;</p>
    ...
    {
    //There is further inquiry, it is case specific, has paid attorney fee, direct PP
        condition:(isFurtherInquiry && isCaseSpecific && hasPaid && isPp),
        message: "Filler"
    }
