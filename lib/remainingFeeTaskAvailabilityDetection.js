    ...
    if(result[localStorageKeys.scriptRunningStatusesDB]){   
        ...
        if(scriptRunStatusDB[scriptNames.remFeeWatch]){
            ...
            chrome.runtime.sendMessage({
                ...
                if(status == runningStatuses.runningStatus && response.permission){
                                ...
                                //Todo: Implement the following logic. 
                                    ...
                                    //IF the latest message is posted by me
                                        ...
                                        //type as been posted by someone else via keywords.
                                            ...
                                            //below, terminate the scripting process and send a notification. 

                                            //If not, continue with the scripting process. 
    

                                    //IF the latest message IS NOT posted by me:
                                        //Terminate the scripting process and send a notification
                    ...
                    console.log(`${scriptNames.remFeeWatch} is not active OR tab has NOT been opened by fetcher`)
                }
            })            
        }
        else{
